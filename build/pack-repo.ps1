...
$nugetPath = "../nuget";
$data = ("..\src\DynamicExcelProvider\DynamicExcelProvider.csproj");
$testExec = $false;
...
function Exec-TestSolution
{
	...
	$result = dotnet test "..\src\tests\GeneralDocumentGeneratorTests\GeneralDocumentGeneratorTests.csproj" *>&1
